        ...
        <DialogPortal>
            ...
            >
                ...
                <DialogPrimitive.Close
                    asChild={route}
                    className="mh:hover:opacity-100 absolute right-4 top-4 rounded-sm opacity-70 ring-offset-white transition-opacity focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-slate-100 data-[state=open]:text-slate-500"
                >
                    {route ? (
                        <Link to="/main">
                            <X className="h-4 w-4" />
