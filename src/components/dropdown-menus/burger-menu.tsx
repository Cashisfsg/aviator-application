                    ...
                    <DropdownMenuLabel className="p-0 text-sm">
                        <div className="flex items-center justify-between p-2.5">
                            <div className="grid w-max grid-cols-[auto_auto] grid-rows-2 items-center gap-x-2.5 leading-none">
                                <img
                                    src="https://c0.klipartz.com/pngpicture/85/114/gratis-png-avatar-usuario-perfil-masculino-logo-icono-de-perfil.png"
                                    alt=""
                                    width="40"
                                    height="40"
                            ...
                            <button className="flex items-center gap-x-1.5 rounded-full border border-[#414148] bg-[#252528] px-2.5 py-1.5 text-[#83878e]">
                                <svg
