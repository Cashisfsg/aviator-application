...
export const TechnicalSupport = () => {
    ...
    return (
        <a
            href={data?.link}
            target="_blank"
            className="fixed right-5 top-[80%] flex items-center gap-x-2 border bg-slate-100/90 px-3 py-2 shadow-md transition-transform duration-200 lg:bg-slate-300 mh:hover:scale-110"
        >
            <FaPhoneVolume />
