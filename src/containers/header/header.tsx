...
import { GameRulesDialog } from "@/components/dialogs/game-rules-dialog";
                    ...
                    <div className="flex items-center justify-between gap-2 xs:gap-4">
                        ...
                        {isAuthenticated ? (
                            <button
                                ...
                                className="h-6 w-6 rounded-full bg-[#2c2d30] p-1 text-center text-sm font-bold leading-none text-slate-400"
                            >
                                <span>?</span>
